...
async function aeroApiScheduled(endpiont, l) {
  ...
  const params = {
    start: new Date(user.selectedDate.getFullYear(), user.selectedDate.getMonth(), user.selectedDate.getDate(), 10, 30).toISOString(),
    end: new Date(user.selectedDate.getFullYear(), user.selectedDate.getMonth(), user.selectedDate.getDate(), 14, 0).toISOString(),
    max_pages: '1',
    url,
  }
  try {
